...
{
    return [CPQuickUIUitil colorFromRed:red green:green blue:blue withAlpha:1.0];
}
...
{
    return [CPQuickUIUitil layerScreenShot:aView.layer];
}

+ (UIImage *)layerScreenShot:(CALayer *)layer
{
    if (CPCheckObjectNull(layer)) {
        return nil;
    }
...
{
    if (CPCheckObjectNull(backgroundImage)) {
        return nil;
    }
...
+ (UIImage *)correctFullSolutionImageFromALAsset:(ALAsset *)asset withScaleSize:(CGFloat)scaleSize
{
    ...
    return [CPQuickUIUitil correctImageOrientation:fullSolutionImage withScaleSize:scaleSize];
}

+ (UIImage *)correctFullSolutionImageFromALAsset:(ALAsset *)asset
{
    return [CPQuickUIUitil correctFullSolutionImageFromALAsset:asset withScaleSize:1.0];
}

+ (UIImage *)correctImageOrientation:(UIImage *)aImage
{
    return [CPQuickUIUitil correctImageOrientation:aImage withScaleSize:1.0];
}
...
+ (UIImage *)roundImage:(UIImage *)aImage
{
    ...
    aImage = [CPQuickUIUitil partImage:aImage withRect:imageRect];
...
{
    return [CPQuickUIUitil gradientLinearImageFromColors:@[fromColor,toColor,fromColor] withImageSize:size];
}

+ (UIImage *)gradientLinearImageFromColors:(NSArray *)colors withImageSize:(CGSize)size;
{
    if (CPCheckObjectNull(colors)) {
        return nil;
    }
...
{
    return [CPQuickUIUitil gradientRadialImageFromColors:@[fromColor,toColor] withImageSize:size];
}
...
{
    return [CPQuickUIUitil gridImageByHoriLineGap:lineGap withVerticalLineGap:0.f withLineColor:lineColor withImageSize:size];
}

+ (UIImage *)gridImageVerticalByLineGap:(CGFloat)lineGap withLineColor:(UIColor *)lineColor withImageSize:(CGSize)size
{
    return [CPQuickUIUitil gridImageByHoriLineGap:0.f withVerticalLineGap:lineGap withLineColor:lineColor withImageSize:size];
}
...
{
    if (CPCheckObjectNull(originImage)) {
        return nil;
    }
...
{
    [CPQuickUIUitil animationDelay:0 animationDuration:duration action:block];
}

+ (void)animationDelay:(NSTimeInterval )delaySecond animationDuration:(NSTimeInterval)duration action:(dispatch_block_t)block
{
    if (CPCheckObjectNull(block)) {
        return;
    }
    
    CPAsyncMainQueueDelay(delaySecond, ^{
...
{
    [CPQuickUIUitil animationView:view delay:0 animationDuration:duration action:block withOptions:options completionBlock:completion];
}
...
{
    [CPQuickUIUitil hiddenShowView:view withDuration:0.3];
}

+ (void)defaultShowHiddenView:(UIView *)view
{
    [CPQuickUIUitil showHiddenView:view withDuration:0.3];
}

+ (void)defaultHiddenView:(UIView *)view
{
    [CPQuickUIUitil hiddenView:view withDuration:0.3];
}

+ (void)defaultShowView:(UIView *)view
{
    [CPQuickUIUitil showView:view withDuration:0.3];
}

+ (void)hiddenView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil animationView:view fromAlpha:view.alpha toAlpha:0 withDuration:duration];
}

+ (void)showView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil animationView:view fromAlpha:view.alpha toAlpha:1 withDuration:duration];
}

+ (void)showView:(UIView *)view finalAlpha:(CGFloat)alpha withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil animationView:view fromAlpha:view.alpha toAlpha:alpha withDuration:duration];
}

+ (void)hiddenShowView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil animationView:view fromAlpha:0 toAlpha:1 withDuration:duration];
}

+ (void)showHiddenView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil animationView:view fromAlpha:1 toAlpha:0 withDuration:duration];
}
...
+ (void)animationView:(UIView *)view fromAlpha:(CGFloat)fAlpha toAlpha:(CGFloat)tAlpha withDuration:(NSTimeInterval)duration
{
    ...
    CPAnimationWithDuration(duration, ^{
...
{
    [CPQuickUIUitil moveView:view originXDetal:moveX originYDetal:0.f widthDetal:0.f heightDetla:0.f withDuration:duration];
}

+ (void)moveViewY:(UIView *)view originYDetal:(CGFloat)moveY withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil moveView:view originXDetal:0.f originYDetal:moveY widthDetal:0.f heightDetla:0.f withDuration:duration];
}

+ (void)moveViewWidth:(UIView *)view widthDetal:(CGFloat)moveWidth withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil moveView:view originXDetal:0.f originYDetal:0.f widthDetal:moveWidth heightDetla:0.f withDuration:duration];
}

+ (void)moveViewHeight:(UIView *)view heightDetal:(CGFloat)moveHeight withDuration:(NSTimeInterval)duration
{
    [CPQuickUIUitil moveView:view originXDetal:0.f originYDetal:0.f widthDetal:0.f heightDetla:moveHeight withDuration:duration];
}
...
+ (void)moveViewToX:(UIView *)view toOriginX:(CGFloat)moveX withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil moveViewX:view originXDetal:detal withDuration:duration];
}
...
+ (void)moveViewToY:(UIView *)view toOriginY:(CGFloat)moveY withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil moveViewY:view originYDetal:detal withDuration:duration];
}
...
+ (void)moveViewToWidth:(UIView *)view toWidth:(CGFloat)moveWidth withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil moveViewWidth:view widthDetal:detal withDuration:duration];
}
...
+ (void)moveViewToHeight:(UIView *)view toHeight:(CGFloat)moveHeight withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil moveViewHeight:view heightDetal:detal withDuration:duration];
}
...
+ (void)moveViewSize:(UIView *)view newSize:(CGSize)size withDuration:(NSTimeInterval)duration
{
    ...
    newFrame.size = size;
    CPAnimationMoveViewRect(view, newFrame, duration);
}
...
+ (void)moveView:(UIView *)view originXDetal:(CGFloat)moveX originYDetal:(CGFloat)moveY widthDetal:(CGFloat)moveWidth heightDetla:(CGFloat)moveHeight withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil moveView:view newRect:newFrame withDuration:duration];
}
...
{
    [CPQuickUIUitil flipView:view fromLeft:YES fromRight:NO fromTop:NO fromBottom:NO action:block withDuration:duration completionBlock:completion];
}
...
{
    [CPQuickUIUitil flipView:view fromLeft:NO fromRight:YES fromTop:NO fromBottom:NO action:block withDuration:duration completionBlock:completion];
}
...
{
    [CPQuickUIUitil flipView:view fromLeft:NO fromRight:NO fromTop:YES fromBottom:NO action:block withDuration:duration completionBlock:completion];
}
...
{
    [CPQuickUIUitil flipView:view fromLeft:NO fromRight:NO fromTop:NO fromBottom:YES action:block withDuration:duration completionBlock:completion];
}
...
+ (void)flipView:(UIView *)view fromLeft:(BOOL)isLeft fromRight:(BOOL)isRight fromTop:(BOOL)isTop fromBottom:(BOOL)isBottom action:(dispatch_block_t)block withDuration:(NSTimeInterval)duration completionBlock:(CPQuickAnimationCompletionBlock)completion;
{
    ...
    if (isLeft) {
        [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromLeft completionBlock:completion];
    }
    if (isRight) {
        [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromRight completionBlock:completion];
    }
    if (isTop) {
        [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromTop completionBlock:completion];
    }
    if (isBottom) {
        [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromBottom completionBlock:completion];
    }
}
...
{
    [CPQuickUIUitil pageUpView:view fromLeft:NO fromRight:NO fromTop:NO fromBottom:YES action:block withDuration:duration completionBlock:completion];
}
...
+ (void)pageUpView:(UIView *)view fromLeft:(BOOL)isLeft fromRight:(BOOL)isRight fromTop:(BOOL)isTop fromBottom:(BOOL)isBottom action:(dispatch_block_t)block withDuration:(NSTimeInterval)duration completionBlock:(CPQuickAnimationCompletionBlock)completion;
{
    ...
    if (isBottom) {
        [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionCurlUp|UIViewAnimationOptionCurveEaseInOut completionBlock:completion];
    }
}
...
{
    [CPQuickUIUitil pageDownView:view fromLeft:NO fromRight:NO fromTop:YES fromBottom:NO action:block withDuration:duration completionBlock:completion];
}
...
+ (void)pageDownView:(UIView *)view fromLeft:(BOOL)isLeft fromRight:(BOOL)isRight fromTop:(BOOL)isTop fromBottom:(BOOL)isBottom action:(dispatch_block_t)block withDuration:(NSTimeInterval)duration completionBlock:(CPQuickAnimationCompletionBlock)completion;
{
    ...
    if (isTop) {
        [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionCurlDown|UIViewAnimationOptionCurveEaseInOut completionBlock:completion];
    }
}
...
+ (void)cubeView:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(CPQuickAnimationCompletionBlock)completion
{
    ...
    [CPQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionCrossDissolve|UIViewAnimationOptionCurveEaseInOut completionBlock:completion];
}
...
+ (void)rotationViewX:(UIView *)view withDegree:(CGFloat)degree withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil animationView:view withAnimationPath:path toValue:CPDegreeToRadiusValue(degree) withDuration:duration];
}
...
+ (void)translationViewX:(UIView *)view withOriginX:(CGFloat)originX withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil animationView:view withAnimationPath:path toValue:@(originX) withDuration:duration];
}
...
+ (void)translationViewY:(UIView *)view withOriginY:(CGFloat)originY withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil animationView:view withAnimationPath:path toValue:@(originY) withDuration:duration];
}
...
+ (void)translationViewZ:(UIView *)view withOriginZ:(CGFloat)originZ withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil animationView:view withAnimationPath:path toValue:@(originZ) withDuration:duration];
}
...
+ (void)scaleViewX:(UIView *)view withScaleSize:(CGFloat)size withDuration:(NSTimeInterval)duration
{
    ...
    [CPQuickUIUitil animationView:view withAnimationPath:path toValue:@(size) withDuration:duration];
}
...
+ (void)animationView:(UIView *)view withAnimationPath:(NSString *)path toValue:(NSValue *)value withDuration:(NSTimeInterval)duration
{
    ...
    [view.layer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"CPAnimation_%@_%lu_%lu_%f",path,(unsigned long)[view hash],(unsigned long)[value hash],duration]];
}

+ (void)view3DRotateX:(UIView *)view withDegree:(CGFloat)degree
{
    [CPQuickUIUitil view3DRotate:view x:1 y:0 z:0 withDegree:CPDegreeToRadius(degree)];
}

+ (void)view3DRotateY:(UIView *)view withDegree:(CGFloat)degree
{
    [CPQuickUIUitil view3DRotate:view x:0 y:1 z:0 withDegree:CPDegreeToRadius(degree)];
}

+ (void)view3DRotateZ:(UIView *)view withDegree:(CGFloat)degree
{
    [CPQuickUIUitil view3DRotate:view x:0 y:0 z:1 withDegree:CPDegreeToRadius(degree)];
}
...
{
    [CPQuickUIUitil view3DTranslate:view x:value y:0 z:0];
}

+ (void)view3DTranslateY:(UIView *)view withValue:(CGFloat)value
{
    [CPQuickUIUitil view3DTranslate:view x:0 y:value z:0];
}

+ (void)view3DTranslateZ:(UIView *)view withValue:(CGFloat)value
{
    [CPQuickUIUitil view3DTranslate:view x:0 y:0 z:value];
}
...
{
    [CPQuickUIUitil view3DScale:view x:value y:0 z:0];
}

+ (void)view3DScaleY:(UIView *)view withValue:(CGFloat)value
{
    [CPQuickUIUitil view3DScale:view x:0 y:value z:0];
}

+ (void)view3DScaleZ:(UIView *)view withValue:(CGFloat)value
{
    [CPQuickUIUitil view3DScale:view x:0 y:0 z:value];
}
...
+ (CPQuickUIUitil *)shareQuickUIUitil
{
    static CPQuickUIUitil *_shareQuickUIInstance = nil;
...
{
    if (CPStringIsNull(blockIdentifier)) {
        return;
    }
    if (self.repeatActionInfoDict.count == 0) {
        return;
...
{
    return  [CPQuickUIUitil repeatDoAction:block withDelay:0.f];
}

+ (NSString *)repeatDoAction:(dispatch_block_t)block withDelay:(NSTimeInterval)delaySecond
{
    return [CPQuickUIUitil repeatDoAction:block withDelay:delaySecond withRepeatDuration:0];
}

+ (NSString *)repeatDoAction:(dispatch_block_t)block withRepeatDuration:(NSTimeInterval)duration
{
    return [CPQuickUIUitil repeatDoAction:block withDelay:0 withRepeatDuration:duration];
}
...
+ (NSString *)repeatDoAction:(dispatch_block_t)block withDelay:(NSTimeInterval)delaySecond withRepeatDuration:(NSTimeInterval)duration
{
    ...
    NSString *blockIdentifier = CPStringCurrentTimeStamp;
    ...
    CPAsyncMainQueueDelay(delaySecond, ^{
        ...
        [[CPQuickUIUitil shareQuickUIUitil]addRepeatBlockInfo:blockActionInfo];
        [[CPQuickUIUitil shareQuickUIUitil]startRepeatAction];
...
+ (void)stopRepeatAction:(NSString *)blockIdentifier
{
    ...
    [[CPQuickUIUitil shareQuickUIUitil]removeBlockInfo:blockIdentifier];
}

+ (void)animationViewXCycle:(UIView *)view withXMoveDetal:(CGFloat)moveX withDuration:(NSTimeInterval)duration
{
    CPAnimationViewTranslationX(view, moveX, duration);
    CPAnimationViewTranslationX(view, 0, duration);
    CPAnimationViewTranslationX(view, -moveX, duration);
    CPAnimationViewTranslationX(view, 0, duration);
}
...
{
    CPAnimationViewTranslationY(view, moveY, duration);
    CPAnimationViewTranslationY(view, 0, duration);
    CPAnimationViewTranslationY(view, -moveY, duration);
    CPAnimationViewTranslationY(view, 0, duration);
}
...
{
    CPAnimationViewTranslationZ(view, moveZ, duration);
    CPAnimationViewTranslationZ(view, 0, duration);
    CPAnimationViewTranslationZ(view, -moveZ, duration);
    CPAnimationViewTranslationZ(view, 0, duration);
}
...
{
    CPAnimationViewRotateX(view, xDegree, duration);
    CPAnimationViewRotateX(view, 0, duration);
    CPAnimationViewRotateX(view, -xDegree, duration);
    CPAnimationViewRotateX(view, 0, duration);
}
...
{
    CPAnimationViewRotateY(view, yDegree, duration);
    CPAnimationViewRotateY(view, 0, duration);
    CPAnimationViewRotateY(view, -yDegree, duration);
    CPAnimationViewRotateY(view, 0, duration);
}
...
{
    CPAnimationViewRotateZ(view, zDegree, duration);
    CPAnimationViewRotateZ(view, 0, duration);
    CPAnimationViewRotateZ(view, -zDegree, duration);
    CPAnimationViewRotateZ(view, 0, duration);
}
...
{
    return [CPQuickUIUitil animationLayer:aLayer path:@"position.x" withFromValue:fromValue withToValue:toValue withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [CPQuickUIUitil animationLayer:aLayer path:@"position.y" withFromValue:fromValue withToValue:toValue withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [CPQuickUIUitil animationLayer:aLayer path:@"position" withFromValue:fromValue withToValue:toValue withRepeatCount:repeatCount withDuration:duration];
}
...
{
    if (CPCheckObjectNull(aLayer) || CPStringIsNull(path) || CPCheckKeyValueHasNull(fromValue, toValue)) {
        return;
    }
    ...
    [aLayer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"CP_animation_%@",path]];
}
...
{
    return [CPQuickUIUitil animationLayer:aLayer path:@"position.x" ByValue:value withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [CPQuickUIUitil animationLayer:aLayer path:@"position.y" ByValue:value withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [CPQuickUIUitil animationLayer:aLayer path:@"position" ByValue:value withRepeatCount:repeatCount withDuration:duration];
}
...
{
    if (CPCheckObjectNull(aLayer) || CPStringIsNull(path) || CPCheckObjectNull(value)) {
        return;
    }
    ...
    [aLayer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"CP_animation_by_%@",path]];
...
+ (UIImage *)imageWithAlpha:(UIImage *)aImage {
    if ([CPQuickUIUitil hasAlpha:aImage]) {
        return aImage;
    }
...
+ (UIImage *)roundedCornerImage:(UIImage *)aImage cornerSize:(NSInteger)cornerSize borderSize:(NSInteger)borderSize {
    ...
    UIImage *image = [CPQuickUIUitil imageWithAlpha:aImage];
    ...
    CGContextBeginPath(context);
    [CPQuickUIUitil addRoundedRectToPath:CGRectMake(scaledBorderSize, scaledBorderSize, image.size.width*scale - borderSize * 2, image.size.height*scale - borderSize * 2)
                                   context:context
...
+ (UIImage *)createRoundCornerImage:(UIImage *)aImage withCornerSize:(NSInteger)cornerSize withBoardSize:(NSInteger)boardSize
{
    ...
    return [CPQuickUIUitil roundedCornerImage:aImage cornerSize:cornerSize borderSize:boardSize];
}
